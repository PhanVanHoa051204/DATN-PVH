    ...
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Details(int id)
        {
            var product = await _context.Products
                .Include(p => p.Category)
                .Include(p => p.ProductImages)
                .Include(p => p.ProductReviews.Where(r => r.IsApproved == true))
        ...
        public async Task<IActionResult> WriteReview(int orderId, int productId)
        {
            ...
            // BƯỚC ĐỘT PHÁ: Chấp nhận mọi thể loại chữ "Hoàn thành"
            ...
            var orderItem = await _context.OrderItems
                ...
                .Include(oi => oi.Order)
                // Dùng .Contains để kiểm tra xem trạng thái có nằm trong danh sách hợp lệ không
                .FirstOrDefaultAsync(oi => oi.OrderId == orderId
                                        && oi.ProductId == productId
                                        && oi.Order.UserId == userId
                                        && validStatuses.Contains(oi.Order.OrderStatus));
            ...
            // Kiểm tra xem khách đã đánh giá món này chưa (chống spam)
        ...
        public async Task<IActionResult> PostReview(int productId, int rating, string comment)
        {
            ...
            var review = new ProductReview
            {
                ...
                IsApproved = true // Đăng phát là hiện luôn trên web
            };
